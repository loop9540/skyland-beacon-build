      ...
      <section className="py-24 md:py-32">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <Reveal>
            ...
            <p className="mt-6 text-foreground/70 text-pretty">
              Calls are confidential, and there's no obligation. When you're ready, here's how to reach us.
            </p>
            <SectionLink
              id="contact"
              className="mt-8 inline-flex items-center gap-2 text-forest border-b border-forest/40 pb-1 hover:border-forest transition-colors"
            >
