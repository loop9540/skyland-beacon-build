...
import { Home, Trees, Flame, Bed } from "lucide-react";
      ...
      <section className="bg-forest text-mist py-24 md:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <Reveal>
            ...
            <h3 className="mt-4 font-display text-4xl md:text-5xl leading-tight font-light max-w-3xl text-balance">
            ...
            {FEATURES.map((f) => (
              <StaggerItem key={f.title}>
                <div className="h-full rounded-2xl border border-mist/15 bg-mist/[0.04] p-8 backdrop-blur-sm">
                  ...
                  <h4 className="mt-5 font-display text-2xl">{f.title}</h4>
      ...
      <section className="py-24 md:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-10">
          <Reveal>
            ...
            <h3 className="mt-4 font-display text-4xl md:text-5xl leading-tight text-balance max-w-2xl">
