  ...
  return (
    <section className="relative pt-32 md:pt-40 pb-20 md:pb-28 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-10 pt-12 md:pt-20">
        <Reveal>
          <div className="eyebrow text-sage">{eyebrow}</div>
          <h1 className="mt-4 font-display text-5xl md:text-7xl font-light leading-[1.02] text-mist text-balance max-w-4xl">
            {title}
          </h1>
          {intro && (
            <p className="mt-6 max-w-2xl text-lg text-mist/85 text-pretty">{intro}</p>
          )}
        </Reveal>
      </div>
    </section>
